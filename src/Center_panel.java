...
public class Center_panel extends JFrame{
    ...
    public static ArrayList<String> label_names = new ArrayList<String>();

    public static ArrayList<JTextField> list_textfield = new ArrayList<JTextField>();
    public static ArrayList<String> textfield_names = new ArrayList<String>();

    public static ArrayList<JPasswordField> list_passwordfield = new ArrayList<JPasswordField>();
    public static ArrayList<String> passwordfield_names = new ArrayList<String>();
    ...
    public static ArrayList<JComboBox<String>> list_combobox = new ArrayList<JComboBox<String>>();
    public static ArrayList<String> combobox_names = new ArrayList<String>();
    ...
    public static ArrayList<JProgressBar> list_bar = new ArrayList<JProgressBar>();
    public static ArrayList<String> bar_names = new ArrayList<String>();
    
    public static ArrayList<JCheckBox> list_checkbox = new ArrayList<JCheckBox>();
    public static ArrayList<String> checkbox_names = new ArrayList<String>();
